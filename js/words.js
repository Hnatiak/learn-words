...
//         "Quel est l'objectif principal d'une étude de marché ?": ["Comprendre le comportement des consommateurs", "Augmenter les ventes", "Améliorer la satisfaction client"],
//         // ... (інші запитання та відповіді для Fondamentaux de la vente)
//     },
//     "etudes": {
...
//         // "Quel outil est couramment utilisé pour analyser la concurrence ?": "La matrice SWOT",
//         // ... (інші запитання та відповіді для Études marketing)
//     }
// };
...
// document.getElementById('fondamentaux-button').addEventListener('click', () => {
//     currentTestType = 'fondamentaux';
//     resetGame(currentTestType);
// });

// document.getElementById('etudes-button').addEventListener('click', () => {
//     currentTestType = 'etudes';
//     resetGame(currentTestType);
// });

// document.getElementById('words-button').addEventListener('click', () => {
//     currentTestType = 'translate';
//     resetGame(currentTestType);
// });

// function getRandomAnswers(correctAnswers, count, questionType) {
//     const allAnswers = questionType === 'translate' ? Object.values(jsonData.translate) :
//                        questionType === 'fondamentaux' ? Object.values(jsonData.fondamentaux).flat() :
//                        Object.values(jsonData.etudes).flat();

//     // Remove the correct answers from the list of all answers
//     const availableAnswers = allAnswers.filter(answer => !correctAnswers.includes(answer));

//     // Ensure there are enough unique answers
//     if (availableAnswers.length + correctAnswers.length < count) {
//         throw new Error('Not enough unique answers available');
//     }
...
// function loadQuestion(testType) {
//     if (currentQuestionIndex >= questions.length) {
//         alert('No more questions. You can stop the game.');
//         return;
//     }
...
//     // Set correct answers based on the test type
//     if (testType === 'translate') {
//         correctAnswers = [jsonData.translate[question]];
//     } else if (testType === 'fondamentaux') {
//         correctAnswers = jsonData.fondamentaux[question];
//     } else if (testType === 'etudes') {
//         correctAnswers = jsonData.etudes[question];
//     }
...
//     // Generate a list of options including one correct answer and some random ones
//     const options = getRandomAnswers(Array.isArray(correctAnswers) ? correctAnswers : [correctAnswers], 3, testType);
...
//     setTimeout(() => {
//         currentQuestionIndex++;
//         loadQuestion(currentTestType);
//     }, 1000);
// }

// function resetGame(testType) {
//     currentQuestionIndex = 0;
//     questions = Object.keys(jsonData[testType]);
